...
//        FirebaseUser currentUser = FirebaseAuth.getInstance().getCurrentUser();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        googleMap.addMarker(new MarkerOptions().position(latLng)).setIcon(BitmapDescriptorFactory.fromResource(R.drawable.dusbin));//.icon(BitmapDescriptorFactory.fromResource(R.drawable.dp)));
